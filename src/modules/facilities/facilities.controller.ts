...
export class FacilitiesController {
  ...
  @Get()
  // Permission tam tat: @Permissions(PermissionEnum.FACILITY_VIEW)
  ...
  @Post()
  // Permission tam tat: @Permissions(PermissionEnum.FACILITY_CREATE)
  ...
  // Permission tam tat: @Permissions(PermissionEnum.FACILITY_UPDATE)
  ...
  @Delete(':id')
  // Permission tam tat: @Permissions(PermissionEnum.FACILITY_DELETE)
