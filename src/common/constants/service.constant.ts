export const SERVICE_CONSTANT = {
  ...
  DOCTOR_SELECTION_INVALID: 'Quy định cho phép chọn bác sĩ phải là giá trị đúng hoặc sai',
  DOCTOR_SPECIALTY_REQUIRED: 'Vui lòng chọn chuyên khoa bác sĩ cho dịch vụ được phép chọn bác sĩ',
  DOCTOR_SPECIALTY_INVALID: 'Chuyên khoa bác sĩ không được vượt quá 255 ký tự',
