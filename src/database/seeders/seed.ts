// import { AccountStatus, ActiveStatus } from './../../common/constants/status.enum';
...
//     const staffRepository = this.connection.getRepository(Staff);
...
//         const email = `${staffData.role}.${facilityData.code.toLowerCase()}@example.com`;
...
//             email,
//             phone: `090${facilityIndex + 1}${String(staffIndex + 1).padStart(6, '0')}`,
//             password,
//             personalEmail: email,
//             employeeCode: `DEMO${facilityIndex + 1}${String(staffIndex + 1).padStart(2, '0')}`,
//             status: AccountStatus.ACTIVE,
//             roles: [],
//           }),
//         );
